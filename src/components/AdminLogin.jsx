...
const AdminLogin = () => {
    ...
    const [error, setError] = useState({ adminNameError: "", mobileNoError: "", passwordError: "" })
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok && success) {
                ...
                const { verify, inform } = responceData
                if (verify) {
            ...
            {LoginFormOpen && <div className="fixed top-20 md:top-36 left-1/2  transform -translate-x-1/2 w-4/5 sm:w-3/5 lg:w-2/5 bg-white p-5 rounded-xl shadow-2xl z-40">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="flex flex-col items-center justify-center gap-2 text-base font-medium">
                        ...
                        <Button disabled={!(adminName && mobileNo && password) || !validMobileNo} className="py-1 rounded-sm px-9 bg-gradient-to-r text-white hover:scale-105 from-pink-600 to-red-500 transition duration-200">Verify</Button>
                    </div>
                </form>
            </div>}
